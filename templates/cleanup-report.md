...
- No duplicate-key warnings: `[yes/no]`
- No undefined citations: `[yes/no]`
- No BibTeX warnings affecting active references: `[yes/no]`
- Rendered reference spot checks completed: `[yes/no]`
